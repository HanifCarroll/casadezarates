...
<main class="min-h-screen bg-rose flex flex-col">
	...
	<div class="flex-1 flex flex-col justify-center max-w-md mx-auto px-8 py-8 text-center pt-32">
		<!-- Airport -->
		<section class="mb-10">
			<h2 class="font-script text-[40pt] text-black mb-1">Airport:</h2>
			<p class="font-sans text-[20pt] text-black whitespace-nowrap">Mexico City International Airport</p>
			<p class="font-sans text-[20pt] text-black">Benito Juarez</p>
		</section>

		<!-- Where to stay -->
		<section class="mb-10">
			<h2 class="font-script text-[40pt] text-black mb-1">Where to stay:</h2>
			<p class="font-sans text-[20pt] text-black">Roma Norte, Roma, La Condesa</p>
			<p class="font-sans text-[20pt] text-black">Juarez</p>
		</section>

		<!-- Check this out -->
		<section class="mb-12">
			<h2 class="font-script text-[40pt] text-black mb-4">Check this out:</h2>
			<div class="flex justify-center">
				...
				>
					<span class="font-script text-black text-[20pt]">Travel</span>
