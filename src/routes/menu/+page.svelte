...
<svelte:head>
	<title>Menu | Markis + Olivia</title>
</svelte:head>

<main class="min-h-screen bg-brown flex flex-col p-8">
	<!-- Close button -->
	<button onclick={closeMenu} class="self-start p-2 hover:bg-white/10 rounded transition-colors">
